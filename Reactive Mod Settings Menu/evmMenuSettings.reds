...
//   let itemDispenseOdds10: Int32 = 50;
  ...
  let eddiesFromIceMachines: Bool = true; // part of VendingMachineHacking
  ...
  let hackArcadeMachines: Bool = true; // part of VendingMachineHacking
  ...
  @runtimeProperty("ModSettings.description", "OFF: drop points keep their default behavior of doing nothing when hit. ON: drop points can break.")
...
//
  ...
  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Vending Machines")
  ...
  @runtimeProperty("ModSettings.max", "100")
  @runtimeProperty("ModSettings.step", "1")
  let vendingMachineMalfunctionRate: Int32 = 90;

  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Vending Machines")
  @runtimeProperty("ModSettings.displayName", "Vending machine short glitch relative odds")
  ...
  @runtimeProperty("ModSettings.step", "1")
  let vendingMachineShortGlitch: Int32 = 11;

  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Vending Machines")
  @runtimeProperty("ModSettings.displayName", "Vending machine static glitch relative odds")
  ...
  @runtimeProperty("ModSettings.max", "11")
  @runtimeProperty("ModSettings.step", "1")
  let vendingMachineStaticGlitch: Int32 = 7;
...
//
  ...
  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Drop Points")
  ...
  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Drop Points")
  @runtimeProperty("ModSettings.displayName", "Drop point short glitch relative odds")
  ...
  @runtimeProperty("ModSettings.max", "11")
  @runtimeProperty("ModSettings.step", "1")
  let dropPointShortGlitch: Int32 = 11;

  @runtimeProperty("ModSettings.mod", "Enhanced VM$")
  @runtimeProperty("ModSettings.category", "Malfunctions: Drop Points")
  @runtimeProperty("ModSettings.displayName", "Drop point static glitch relative odds")
  ...
  @runtimeProperty("ModSettings.max", "11")
  @runtimeProperty("ModSettings.step", "1")
  let dropPointStaticGlitch: Int32 = 6;
